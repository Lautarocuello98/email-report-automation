...
Example dataset used as input with realistic client reporting fields.

![Clients CSV](images/new_csv.png)

---

### 📧 Generated Email

Example personalized email automatically generated by the system.

![Email Example](images/new_email.png)

---

### 📊 Generated Excel Report

Example individual Excel report created for each client.

![Excel Report](images/new_excel.png)
...
- order count
- status
- structured Excel output with professional formatting ready for delivery
...
- CSV row validation
- total sales normalization
- order count normalization
- report filename sanitization
- template loading
- Excel report generation
- SMTP configuration validation
- logging behavior
- workflow skip and dry-run behavior
